...
def interest(principal, rate, periods):
    ...
    def interest(principal, rate, period):
        return math.floor((principal * (rate * period)) + principal)
...
def body_mass_index(weight, height):
    ...
    # Stay within the function. Only use the parameters as input. The function should return your answer.
    def body_mass_index(weight, height):
        heightInches = ( height[0] * 12 ) + height[1]
        heightM = (heightInches  * 2.54) / 100
        return (weight*0.453592)/(heightM * heightM)

    body_mass_index(115, [5, 2])